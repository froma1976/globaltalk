      ...
      <div className="bg-white pb-8 pt-12 px-6 shadow-sm border-b border-slate-100">
         <div className="max-w-md mx-auto">
            <div className="flex items-center space-x-2 mb-2">
                ...
                <span className="text-sm font-bold text-indigo-600 tracking-wider uppercase">Gemini 2.5 Powered</span>
            </div>
            <h1 className="text-3xl font-extrabold text-slate-900 mb-2">LinguaFlow AI</h1>
